...
move the generateToken function to utils
create token user for the attachcookie
fix my user object returned by mongo
ask what that thing that tells if youre in production or not is
